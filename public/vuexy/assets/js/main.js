        ...
        var a,
            ...
            s =
                (window.templateCustomizer &&
                    ...
                    (s = s.querySelector("i")),
                    "light" === n
                        ? (s.classList.add("ti-sun"), new bootstrap.Tooltip(s, { title: "Light Mode", fallbackPlacements: ["bottom"] }))
                        : "dark" === n
                        ? (s.classList.add("ti-moon"), new bootstrap.Tooltip(s, { title: "Dark Mode", fallbackPlacements: ["bottom"] }))
                        : (s.classList.add("ti-device-desktop"), new bootstrap.Tooltip(s, { title: "System Mode", fallbackPlacements: ["bottom"] }))),
