            ...
            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                ...
                <div class="dt-action-buttons text-end pt-3 pt-md-0">
                    <div class="dt-buttons">
                        <a href="/categories/procurements/create"
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $procurement_item->publish ? "Published" : "Not Published" }}</td>
                    <td>
                ...
                @php
                $subcategory = \App\Models\Procurement::where(['parent' => $procurement_item->id,'type' =>2,'alterproc' =>0])->get();
                @endphp
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-center">
                    <a href="/categories/procurements/{{$sub_category_item->id  }}/edit" class="mr-2 edit btn btn-sm btn-info"><i class="fa fa-pencil-alt"></i> Edit</a>
