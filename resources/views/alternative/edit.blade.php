...
@section('content')
    ...
    <div class="card">
        <form action="/procurements/{{$procurement->id}}/update" method="post" id="member-form" enctype="multipart/form-data">
            @csrf
        <div class="col-md-12">
            <div class="card mb-12">
              <h5 class="card-header">Edit Procurement</h5>
              <div class="card-body">
                <div class="mt-2 mb-3">
                  ...
                  <select name="parent" id="defaultSelect" class="form-select">
                    ...
                    <option value="{{ $category_item->id }}">{{ $category_item->name }}&nbsp;</option>
                        @php
                        $subcategory = \App\Models\Procurement::where(['parent' => $category_item->id,'type' =>2])->orderBy('name', 'ASC')->get();
                        @endphp
